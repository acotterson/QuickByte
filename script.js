...
function foodOptions(cat) {
  ...
  navigator.geolocation.getCurrentPosition(function (position) {
    ...
    var yelp = "https://bootcamp-cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?categories=" + cat + "&limit=6&open_now=true&latitude=" + lat + "&longitude=" + long + "&radius=5000";
    $.ajax({
      url: yelp,
      headers: {
